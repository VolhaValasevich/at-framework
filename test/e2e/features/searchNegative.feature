Feature: iKnow Search
  ...
  @fail
  Scenario: User searches for a "law" term and opens a document
    Given I open base url
    When I clear value in "Home Search Input"
    And I type "law" in "Home Search Input"
    ...
    And Text of "Highlighted Terms #1" should contain "value" being case insensitive
